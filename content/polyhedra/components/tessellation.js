...
const SHAPES = {
  ...
  5: {points: '0,-51.1 -48.5,-15.8 -30,41.2 30,41.2 48.5,-15.8 0,-51.1', colour: '#22ab24'},
  6: {points: '0,-60 52,-30 52,30 0,60 -52,30 -52,-30', colour: '#cd0e66'},
  8: {points: '30,-72.5 -30,-72.5 -72.5,-30 -72.5,30 -30,72.5 30,72.5 72.5,30 72.5,-30 30,-72.5', colour: '#6f27cc'}
};
