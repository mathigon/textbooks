...
import {SVGView, animate, InputView, AnimationResponse, ElementView} from '@mathigon/boost';
...
/**
 * A table and text input for creating emoji-based codes
 */
export function emojiCodes($section: Step) {
 ...
 */
export function krii8it($section: Step) {
...
/**
 * A quiz for testing parity bits
 */
export function hamming($step: Step) {

  const $gameplay = $step.$('x-gameplay') as Gameplay;

  // HAMMING: instead of a full string, leave a parity bit open like 000_1101
