...
paths, called ____ Sie glaubten, dass diese Umlaufbahnen
...
{.caption} Die Erde steht im Mittelpunkt des _ptolemäischen Universums__.
...
Jeder Punkt auf einem [__Kreis__ ](gloss:Kreis) hat den gleichen Abstand von seinem 
Mittelpunkt. Das bedeutet, dass sie mittels eines [Zirkels](gloss:Zirkel) gezeichnet werden können:
...
Mittelpunkt, und seine Länge ist [[doppelt|halb|gleich]] groß wie der Radius.
...
[ähnlich](gloss:ähnlich) sind. Du kannst das überprüfen, indem du zeigst, dass alle Kreise durch einfache [Translationen](gloss:Translation) und [Dilatationen](gloss:Dilatation) exakt passend übereinander gelegt werden können:
...
dem [Umfang](gloss:Kreisumfang) und dem 
[Durchmesser](gloss:Kreisdurchmesser) ist für _alle Kreise gleich groß_. Es ist immer
...
bei einem Kreis mit dem [Radius](gloss:Kreis-Radius) _r_ der Umfang 
...
[[halben Umfang|Umfang|doppelten Radius]] des Kreises._
...
{.reveal(when="slider")} Wenn wir die Anzahl der Tortenstücke auf ${n2}{n2|4|2,12,1}erhöhen, beginnt
diese Form immer mehr wie ein [[dreieck|Rechteck|Trapez|Trapez]] auszusehen.

{.reveal(when="blank-0")} Die Höhe des Dreiecks entspricht dem 
[[Radius|Durchmesser|Umfang]] des Kreises.
_{span.reveal(when="blank-1")} Die Basis des Dreiecks ist gleich [[der
Umfang|der doppelte Durchmesser]] des Kreises._
...
werden als [__irrationale Zahlen ]__(gloss:irrationale Zahlen) bezeichnet, und das bedeutet, dass `π`
...
ein Beispiel, das
1676 von [Gottfried Wilhelm Leibniz](bio:leibniz) entdeckt wurde:
...
normale Zahl__ist__. Das bedeutet, dass die Ziffern von 0 bis 9 völlig
...
Bisher haben wir in der Geometrie immer Winkel in[Grad](gloss:Grad) gemessen. Eine
__{.m-red}__Vollkreisrotation ist [[360]]°, ein __{.m-green}Halbkreis__ ist [
[180]]°, ein __{.m-yellow}Viertelkreis__ ist [[90]]°, und so weiter.
