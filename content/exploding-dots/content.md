...
However, numbers have one important property that we usually take for granted
without thinking about it: all numbers are __unique__. In other words, there are
no two different numbers that are equal. 5 is different from 8, 100 is different
from 101, and so on.
...
![](http://gdaymath.com/wp-content/uploads/2018/03/P1.jpg)
...
Could 0.9999… instead be quantity sitting just to the right of  on the number line?

This feels unlikely since all the numbers 0.9, 0.99, 0.999, … sit to the left of 1 with 1 being an upper barrier to them all.
...
If you choose to believe that 0.9999… is a valid arithmetical quantity (that might or might not be 1), then you probably would also choose to believe that it obeys all the usual rules of arithmetic. If so, then we can conduct a lovely swift algebra argument so show that, because of these beliefs, the quantity  0.9999… does indeed equal 1. The argument goes as follows.

STEP 1: Give the quantity a name.

We’ll call it F for Fredericka:
...
Notice 10F and F differ only by 9  in the ones place and so 10F–F is 9. That is, we have
...
The mathematics thus establishes that  0.9999…=1.
...
Here’s a picture of 0.9999… in a 1←10 machine with decimals.

![](http://gdaymath.com/wp-content/uploads/2018/03/p2.jpg)

Place a dot and an antidot in the first box. This doesn’t change the number.

![](http://gdaymath.com/wp-content/uploads/2018/03/p3.jpg)

But now we can perform an explosion.

![](http://gdaymath.com/wp-content/uploads/2018/03/p4.jpg)

The number in this picture which looks like 1.−1|9|9|9… is still 0.9999….

Now add another dot-antidot pair and perform another explosion. There is now also an annihilation.

![](http://gdaymath.com/wp-content/uploads/2018/03/p5.jpg)

Now we have 1.0|−1|9|9… is the same as 0.9999….

And do this again

![](http://gdaymath.com/wp-content/uploads/2018/03/p6.jpg)

and again, and again, and again, forever.

It looks like we are actually showing that 0.9999… is the same as 1.0000….
