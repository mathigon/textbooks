...
::: column.grow
نجد حولنا كل يوم عدد كبير من الترابطات والشبكات: الشوارع وسكك القطارات وخطوط الهاتف وشبكات الإنترنت والدوائر الكهربية وحتى الترابطات الجزيئية. وتوجد أيضا _روابط اجتماعية_  بين الأصدقاء و العائلات.  كل هذه الأنظمة تتكون من _نقاط_ محددة تسمى [[ رؤوس | دوائر | تقاطعات]] وتتصل بعض من هذه النقاط ببعضها بواسطة [[ حواف | حدود | أزواج]]. فى علم الرياضيات يطلق على هذا اسم [__مخطط__](gloss:graph).
::: column(width=160)
