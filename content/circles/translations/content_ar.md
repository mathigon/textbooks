...
لاحظ كيف يأخذ القوس والقطاع والزاوية _نفس النسبة_ من الدائرة الكاملة. على سبيل المثال ، إذا كان [{.blue} الزاوية المركزية](target:angle) _{span.var-action} 90 درجة_ ، يستغرق [[ربعه | نصف | ثلث]] أ [{.teal} دائرة كاملة](target:fangle) . 
