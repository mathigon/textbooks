...
{.caption} Этот __папоротник__ состоит из множества маленьких листочков, которые соединяются в более крупный лист.
...
{.caption} Этот __брокколи__ Романеско состоит из небольших [[конусов|кубиков|сфер]], закрученных по спирали вокруг большого.
...
{.reveal(when="slider=0")} Обратите внимание, что окончательная форма состоит из [трех идентичных копий себя](target:x), и каждая из них состоит из еще меньших копий большого треугольника! Вы можете продолжать увеличивать масштаб в треугольнике постоянно, а картинка и формы всегда будут повторяться.
...
На каждой итерации мы удаляем некоторые области треугольника Серпинского. Если бы мы продолжили делать это бесконечно много раз, то удалили бы всю площадь: вот почему треугольник Серпинского - это нечто среднее между двухмерной областью и одномерной линией..
...
Есть много фигур в природе, которые выглядят как фракталы. Мы уже видели некоторые растения в начале этой главы. Другими важными примерами являются снежинки и ледяные кристаллы::
...
{.reveal(when="blank-0")} Получившаяся форма называется [__снежинка Коха__](gloss:koch-snowflake), названная в честь шведского математика [Хельге фон Кох](bio:koch). Еще раз обратите внимание, что [маленький участок](target:t2) края снежинки выглядит точно так же, как [большой участок](target:t1).
...
Создание снежинок Коха похоже на [рекурсивную последовательность](gloss:sequence-recursive): мы знаем начальную форму (треугольник) и знаем, как переходить от одного элемента к другому (добавляя больше треугольников на каждом ребре):
...
{.caption} ««Моя душа вьется ледяным узором повсюду...»»
...
Это серьезная проблема при попытке рассчитать длину границы страны - нужно решить, насколько сильно увеличивать масштаб, и нужно ли включать укромные уголки и трещины?
...
Если мы повторим это с более крупными сетками, мы обнаружим, что размерность береговой линии Британии фактически равна 1,21. Мандельброт понял, что эта фрактальная размерность также является мерой __шероховатости__ формы - новый показатель, который нашел приложение во многих других областях математики и физики.
...
Треугольник Паскаля можно достраивать бесконечно, и фигура Серпинского будет продолжаться, создавая треугольники все больше и больше. Вы уже можете увидеть начало большого треугольника, который начинается на строке 16.
...
{.r.reveal(when="point")} Давайте играть в простую игру: мы выбираем одну из вершин треугольника случайным образом, рисуем отрезок прямой между нашей точкой и вершиной треугольника, а затем находим [{.pill.red} середину](target:p1) этого отрезка. [Продолжить](btn:next)

{.r.reveal(when="next-0")} Теперь мы повторяем процесс: мы выбираем случайную вершину, рисуем отрезок от нашей последней точки, а затем находим [{.pill.green} середину](target:p2). Обратите внимание, что мы окрашиваем эти новые точки в зависимости от цвета вершины треугольника, которую мы выбрали. [Продолжить](btn:next)
...
{.reveal(when="s1 s2 play")} У вас получилось построить [ковёр Серпинского](action:carpet()) или [пятилучевую снежинку](action:snowflake()) на основе [__Золотого сечения__](gloss:golden-ratio)?
...
Существует много вариантов треугольника Серпинского и других фракталов со схожими свойствами и процессами создания. Некоторые выглядят двумерными, как ковёр Серпинского, который вы видели выше. Другие выглядят трехмерными, как эти примеры:
